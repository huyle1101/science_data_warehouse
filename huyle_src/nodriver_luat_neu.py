...
OUTPUT_DIR = 'f:/science_data_warehouse_repo/output/neu/luat/raw_data'
os.makedirs(OUTPUT_DIR, exist_ok=True)
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"luat_{timestamp}.jsonl")

LOG_DIR = 'f:/science_data_warehouse_repo/output/neu/luat/logs'
os.makedirs(LOG_DIR, exist_ok=True)
LOG_FILE = os.path.join(LOG_DIR, f"luat_{timestamp}.log")
...
LISTING_URL = "https://khoaluat.neu.edu.vn/vi/giang-vien-khoa-luat"
...
async def main():
    ...
    base_url = "https://khoaluat.neu.edu.vn"
