...
OUTPUT_DIR = 'f:/science_data_warehouse_repo/output/neu/qtnnl/raw_data'
os.makedirs(OUTPUT_DIR, exist_ok=True)
OUTPUT_FILE = os.path.join(OUTPUT_DIR, f"qtnnl_{timestamp}.jsonl")

LOG_DIR = 'f:/science_data_warehouse_repo/output/neu/qtnnl/logs'
os.makedirs(LOG_DIR, exist_ok=True)
LOG_FILE = os.path.join(LOG_DIR, f"qtnnl_{timestamp}.log")
...
LISTING_URL = "https://khoaquanlynguonnhanluc.neu.edu.vn/vi/nhom-nganh-cong-nghe-thong-tin"
...
async def main():
    ...
    while 1:
        ...
        if next_page_button:
            ...
            page += 1
            if page==5:
                break # information on page 5 is mismatched
            tmp = {}
    ...
    base_url = "https://khoaquanlynguonnhanluc.neu.edu.vn/"
    for url in data_dict.keys():
        try:
            ...
            record = {
                ...
                "don_vi_truc_thuoc": "Khoa Quản trị nguồn nhân lực",
                "is_extracted": False,
